@if($isLocked)
<a href="#" onclick="event.preventDefault(); showModuleLockedModal('{{ $text }}');" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors opacity-60 cursor-pointer" style="background-color: rgba(var(--primary), 0.05);">
    {!! $icon !!}
